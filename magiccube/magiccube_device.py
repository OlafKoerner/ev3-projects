...
def main(p1, p2, p3, p4):
    ...
    motor_a.run_to_rel_pos(position_sp=p1, speed_sp=200)
    while motor_a.is_running: sleep(0.1)
    sleep(1)

    motor_a.run_to_rel_pos(position_sp=p2, speed_sp=200)
    while motor_a.is_running: sleep(0.1)
    sleep(1)

    motor_b.run_to_rel_pos(position_sp=p3, speed_sp=200)
    while motor_b.is_running: sleep(0.1)
    sleep(1)

    motor_b.run_to_rel_pos(position_sp=p4, speed_sp=150)
    while motor_b.is_running: sleep(0.1)
    sleep(1)
